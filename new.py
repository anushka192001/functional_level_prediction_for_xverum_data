...
unique_functions = ['finance', 'sales', 'operations', 'hr', 'marketing', 'manufacturing', 'compliance', 'engineering', 'legal', 'it', 'admin','production']
...
model1 = DistilBERTClass.from_pretrained('anushkaSingh/multilingual_distillbert_finetuned_for_functional_level_prediction')
